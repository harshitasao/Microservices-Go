...
type ClientService interface {
	...
	DeleteProducts(params *DeleteProductsParams, opts ...ClientOption) (*DeleteProductsCreated, error)
...
/*
DeleteProducts Returns a list of products
*/
func (a *Client) DeleteProducts(params *DeleteProductsParams, opts ...ClientOption) (*DeleteProductsCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
